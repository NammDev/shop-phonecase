...
import PhonePreview from './phone-review'
import { getPaymentStatus } from '@/lib/actions/order'
        ...
        <div className='mt-10 border-t border-zinc-200'>
          <div className='mt-10 flex flex-auto flex-col'>
            ...
            <p className='mt-2 text-sm text-zinc-600'>
              ...
              last you for the years to come. We offer a 5-year print guarantee: If you case isn't
